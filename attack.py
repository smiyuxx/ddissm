...
def usage():
    print "./attack.py -t <target> [-r <threads> -p <port> -T -h]"
    ...
    print "Eg. ./attack.py -t 192.168.1.100 -r 800 -p 80"
...
if __name__ == "__main__":
    print "\n/*"
    print " *"+term.RED + " Ddos Attack - Uma ferramenta POST DoS mais effeciente! "+term.NORMAL
    print " * HTTP POST lento de carga de servidor ferramenta de teste"
    print " * Traduzido e Editador Resende"
    print " * Route Through Tor"
    print " * Conhecimento nao e crime, mais seus atos sim."
    print " */\n"
